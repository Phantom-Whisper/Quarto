...
public class MatrixLayout : Layout
{
    public static readonly BindableProperty NbColumnsProperty
        = BindableProperty.Create(nameof(NbColumns), typeof(int), typeof(MatrixLayout), 4);
    ...
    public static readonly BindableProperty NbRowsProperty
        = BindableProperty.Create(nameof(NbRows), typeof(int), typeof(MatrixLayout), 4);
    ...
    public static readonly BindableProperty HorizontalSpacingProperty
        = BindableProperty.Create(nameof(HorizontalSpacing), typeof(double), typeof(MatrixLayout), 0.0);
    ...
    public static readonly BindableProperty VerticalSpacingProperty
        = BindableProperty.Create(nameof(VerticalSpacing), typeof(double), typeof(MatrixLayout), 0.0);
